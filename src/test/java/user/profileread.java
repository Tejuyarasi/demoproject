...
public class profileread {
	@Test (priority=1)
	public void valid() {
		String url ="https://dev.api.atomzpower.com/api/v1/user/profileRead";
...
public void invalid_uri() {
	String url ="https://dev.api.atomzpower.com/api/v1/user/profileRe";
	String contentType="application/json";
	String bodyData="{\n"
			+ "    \"mobileNumber\": \"6301012066\"\n"
			+ "}";
...
public void invalid_token() {
	...
	Response response = RestAssured.given().header("token","eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ2YWx1ZSI6eyJfaWQiOiI2MzRlOGQ4MTQwY2QzMzg1MDRlZTg2MWUiLCJtb2JpbGVOdW1iZXIiOiI2MzAxMDEyMDY2IiwiZW1ha")
			.contentType(contentType)
			.body(bodyData)
			.when()
			.post(url)
